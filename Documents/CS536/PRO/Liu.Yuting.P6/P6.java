...
public class P6 {
	...
	public int process(PrintWriter p){
		...
		astRoot.nameAnalysis(0);  // perform name analysis
		
		if(ErrMsg.getErr()) {
			return P6.RESULT_NAME_ERROR;
		}
		
		astRoot.typeCheck(); // perform type analysis
		...
		if (ErrMsg.getErr()){
			...
			return P6.RESULT_TYPE_ERROR;
                ...
                astRoot.codeGenerator(p); // call root's code generator
